    ...
    <div class="flex flex-col gap-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6 px-4">
            ...
            <article>
                ...
                <header class="mt-2">
                    <h1 class="text-xl text-center text-gray-700 dark:text-gray-200">
                        <a href="{{ route('dashboardconfiguraciones') }}">Configuraciones</a>
                    </h1>
                </header>
            </article>
            ...
            <article>
                ...
                <header class="mt-2">
                    <h1 class="text-xl text-center text-gray-700 dark:text-gray-200">
                        <a href="{{ route('dashboardcompras') }}">Compras</a>
                    </h1>
                </header>
            </article>
            <article>
                <figure>
                    <img class="object-cover w-full rounded-xl h-36" src="{{ asset('img/customers.jpg') }}" alt="Roles">
                </figure>
                <header class="mt-2">
                    <h1 class="text-xl text-center text-gray-700 dark:text-gray-200">
                        <a href="{{ route('dashboardventas') }}">Ventas</a>
                    </h1>
                </header>
            </article>
            ...
            <article>
             ...
             <article>
                <figure>
                    <img class="object-cover w-full rounded-xl h-36" src="{{ asset('img/ecommerce.jpg') }}" alt="Roles">
                </figure>
                <header class="mt-2">
                    <h1 class="text-xl text-center text-gray-700 dark:text-gray-200">
                        <a href="">Web</a>
            ...
            <article>
                <figure>
                    <img class="object-cover w-full rounded-xl h-36" src="{{ asset('img/inventario.jpg') }}" alt="Roles">
                </figure>
                <header class="mt-2">
                    <h1 class="text-xl text-center text-gray-700 dark:text-gray-200">
            ...
            <article>
                <figure>
                    <img class="object-cover w-full rounded-xl h-36" src="{{ asset('img/contable.jpg') }}" alt="Roles">
                </figure>
                <header class="mt-2">
                    <h1 class="text-xl text-center text-gray-700 dark:text-gray-200">
                        <a href="">Contable</a>
