<div class="space-y-6">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow p-5 flex justify-between items-center">
        <div>
            <h1 class="text-2xl font-bold text-gray-800 dark:text-gray-100">Crear Ubicación</h1>
            <p class="text-sm text-gray-500 dark:text-gray-300">Define una nueva ubicación física dentro del almacén.</p>
        </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow overflow-hidden">
        <div class="px-6 pt-5 border-b border-gray-200 dark:border-gray-700">
            <button wire:click="setTab('general')"
                ...
                <i class="fa-solid fa-map-pin mr-2"></i> Datos Generales
            </button>
        </div>
        ...
        <div class="p-6">
            ...
            <div class="mt-8 pt-6 border-t border-gray-100 dark:border-gray-700 flex justify-end">
                <button wire:click="save" wire:loading.attr="disabled"
                    ...
                    <span wire:loading.remove>Guardar Ubicación</span>
