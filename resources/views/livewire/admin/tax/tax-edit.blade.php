<div class="space-y-6">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow p-5">
        <div class="flex items-center justify-between gap-4">
            <div>
                <h1 class="text-2xl font-bold text-gray-800 dark:text-gray-100">Editar impuesto</h1>
                <p class="text-sm text-gray-500 dark:text-gray-300">
                    Editando: <span class="font-semibold">{{ $tax->name }}</span>
                    <span class="mx-2">·</span>
                    ID: <span class="font-semibold">#{{ $tax->id }}</span>
                </p>
            </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow">
        ...
        <div class="p-6 space-y-6">
            @if ($tab === 'general')
                ...
                <div class="grid grid-cols-1 md:grid-cols-12 gap-5">
                    ...
                    <div class="md:col-span-9">
                        ...
                        <input wire:model.defer="name" type="text"
                            placeholder="Ej: IGV 18% (Venta), Exonerado, ISC 10%..." class="{{ $controlBase }} mt-2">
                        @error('name')
                ...
                {{-- ── Fila 2: Tipo cálculo + Monto + Ámbito uso + Ámbito fiscal ── --}}
                <div class="grid grid-cols-1 md:grid-cols-12 gap-5">
                    ...
                    <div class="md:col-span-2">
                        <label class="text-sm font-semibold text-gray-700 dark:text-gray-200">Ámbito fiscal</label>
                        <input wire:model.defer="tax_scope" type="text" placeholder="Ej: peru"
                            class="{{ $controlBase }} mt-2">
                        @error('tax_scope')
                            <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                        @enderror
                ...
                {{-- ── Fila 3: Cuenta contable + Descripción ── --}}
                <div class="grid grid-cols-1 md:grid-cols-12 gap-5">

                    <div class="md:col-span-6">
                        <label class="text-sm font-semibold text-gray-700 dark:text-gray-200">Cuenta contable</label>
                    ...
                    <div class="md:col-span-6">
                        ...
                        <input wire:model.defer="description" type="text"
                            placeholder="Descripción breve del impuesto..." class="{{ $controlBase }} mt-2">
                        @error('description')
                            <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-12 gap-5">
                    ...
                    <div class="md:col-span-3">
                        <label class="text-sm font-semibold text-gray-700 dark:text-gray-200">Precio incluye
                            impuesto</label>
                        <div
                            ...
                            <label class="inline-flex items-center gap-2 text-sm text-gray-700 dark:text-gray-200">
                                <input type="radio" wire:model.defer="price_include" value="1">
                                <span>Sí</span>
                            </label>
                            <label class="inline-flex items-center gap-2 text-sm text-gray-700 dark:text-gray-200">
                                <input type="radio" wire:model.defer="price_include" value="0">
                                <span>No</span>
                            </label>
                        </div>
                        @error('price_include')
                    ...
                    <div class="md:col-span-3">
                        ...
                        <div
                            class="mt-2 h-12 flex items-center justify-between gap-4 px-4 rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700">
                            <label class="inline-flex items-center gap-2 text-sm text-gray-700 dark:text-gray-200">
                                <input type="radio" wire:model.defer="include_base_amount" value="1">
                                <span>Sí</span>
                            </label>
                            <label class="inline-flex items-center gap-2 text-sm text-gray-700 dark:text-gray-200">
                                <input type="radio" wire:model.defer="include_base_amount" value="0">
                                <span>No</span>
                            </label>
                        </div>
                        @error('include_base_amount')
                            <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="md:col-span-3">
                        ...
                        <div
                            class="mt-2 h-12 flex items-center justify-between gap-4 px-4 rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700">
                            <label class="inline-flex items-center gap-2 text-sm text-gray-700 dark:text-gray-200">
                                <input type="radio" wire:model.defer="is_base_affected" value="1">
                                <span>Sí</span>
                            </label>
                            <label class="inline-flex items-center gap-2 text-sm text-gray-700 dark:text-gray-200">
                                <input type="radio" wire:model.defer="is_base_affected" value="0">
                                <span>No</span>
                            </label>
                        </div>
                        @error('is_base_affected')
                            <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                        @enderror
                    </div>
