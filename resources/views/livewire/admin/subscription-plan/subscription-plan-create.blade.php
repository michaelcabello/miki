<div class="space-y-6">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow p-5">
        <div class="flex items-center justify-between gap-4">
            <div>
                <h1 class="text-2xl font-bold text-gray-800 dark:text-gray-100">Crear plan de suscripción</h1>
                <p class="text-sm text-gray-500 dark:text-gray-300">
                    Define la frecuencia de cobro recurrente para un producto o servicio.
                </p>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-12 gap-5">
                    ...
                    <div class="md:col-span-6">
                        ...
                        <input wire:model.defer="name" type="text"
                            placeholder="Ej: Mensual, Anual Pro, Trimestral..."
                        ...
                        <div class="rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900/30 p-5">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                                <div>
                                    ...
                                    <input wire:model.defer="interval_count" type="number" min="1" step="1"
                                        class="{{ $controlBase }} mt-2" placeholder="1">
                                    <p class="text-xs text-gray-500 mt-1">Número de unidades de tiempo.</p>
                            ...
                            <div class="mt-4 p-3 rounded-lg bg-indigo-50 dark:bg-indigo-900/20 border border-indigo-100 dark:border-indigo-900/40 text-sm text-indigo-700 dark:text-indigo-300">
                                <i class="fa-solid fa-circle-info mr-2"></i>
                                Ejemplos: Cada 1 mes → <strong>Mensual</strong> · Cada 12 meses → <strong>Anual</strong> · Cada 3 meses → <strong>Trimestral</strong>
                            </div>
                        </div>
                    </div>
                ...
                @can('SubscriptionPlan Create')
                    <div class="pt-2 flex justify-end">
                        <button wire:click="save"
                            ...
                            <i class="fa-regular fa-floppy-disk"></i> Guardar plan
                        </button>
                    </div>
                @endcan
            @endif
