<div class="space-y-6">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow p-5">
        <div class="flex items-center justify-between gap-4">
            <div>
                <h1 class="text-2xl font-bold text-gray-800 dark:text-gray-100">Editar partner</h1>
                <p class="text-sm text-gray-500 dark:text-gray-300">
                    Actualiza la empresa/persona principal.
                </p>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-12 gap-5">
                    ...
                    <div class="md:col-span-3">
                        ...
                        <div class="mt-2 flex gap-2">
                            <input wire:model.defer="document_number" wire:keydown.enter="searchDocument"
                                type="text" placeholder="DNI / RUC" class="{{ $controlBase }} flex-1">
                    ...
                    <div class="md:col-span-6">
                        ...
                        <input wire:model.defer="name" type="text" class="{{ $controlBase }} mt-2">
                        @error('name')
                            <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="md:col-span-6">
                        ...
                        <input wire:model.defer="street" type="text" class="{{ $controlBase }} mt-2">
                        @error('street')
                            <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="md:col-span-4">
                        ...
                        <input wire:model.defer="email" type="email" class="{{ $controlBase }} mt-2">
                        @error('email')
                            <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input wire:model.defer="phone" type="text" class="{{ $controlBase }} mt-2">
                    </div>

                    <div class="md:col-span-2">
                        <label class="text-sm font-semibold text-gray-700 dark:text-gray-200">WhatsApp</label>
                        <input wire:model.defer="whatsapp" type="text" class="{{ $controlBase }} mt-2">
                    </div>

                    <div class="md:col-span-2">
                        <label class="text-sm font-semibold text-gray-700 dark:text-gray-200">Móvil</label>
                        <input wire:model.defer="mobile" type="text" class="{{ $controlBase }} mt-2">
                    </div>

                    <div class="md:col-span-2">
                        <label class="text-sm font-semibold text-gray-700 dark:text-gray-200">Website</label>
                        <input wire:model.defer="website" type="text" class="{{ $controlBase }} mt-2">
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <select wire:key="province-select-{{ $department_id ?? 'none' }}" wire:model.live="province_id"
                            @disabled(!$department_id) class="{{ $controlBase }} mt-2">
                            <option value="">— Seleccionar —</option>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="mt-2 h-12 flex items-center justify-between gap-4 px-4 rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700">
                            <label class="inline-flex items-center gap-2 text-sm text-gray-700 dark:text-gray-200">
                                <input type="radio" wire:model.defer="status" value="1"> <span>Activo</span>
                            </label>
                            <label class="inline-flex items-center gap-2 text-sm text-gray-700 dark:text-gray-200">
                                <input type="radio" wire:model.defer="status" value="0"> <span>Desactivo</span>
                            </label>
                        </div>
                    </div>
                    ...
                    {{-- <div class="md:col-span-2">
                        ...
                        <div class="mt-2 h-12 flex items-center gap-3 px-4 rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700">
                    ...
                    <div class="md:col-span-12">
                        ...
                        <input wire:model.defer="map" type="text" class="{{ $controlBase }} mt-2">
                    </div>
            ...
            @if ($tab === 'accounting')
                <div class="space-y-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div>
                            <label class="text-sm font-semibold text-gray-700 dark:text-gray-200">Cuenta por cobrar</label>
                        ...
                        <div>
                            <label class="text-sm font-semibold text-gray-700 dark:text-gray-200">Cuenta por pagar</label>
