        ...
        <div class="flex items-center justify-between gap-4">
            <div>
                ...
                <p class="text-sm text-gray-500 dark:text-gray-300">
                    Editando: <span class="font-semibold">{{ $jt->name }}</span>
                    <span class="mx-2">·</span>
                    Código: <span class="font-semibold">{{ $jt->code }}</span>
                </p>
            </div>
            ...
            @if ($tab === 'general')
                <div class="grid grid-cols-1 md:grid-cols-12 gap-5">
                    ...
                    <div class="md:col-span-4">
                        ...
                        <input wire:model.live="code" type="text"
                            ...
                            placeholder="Ej: SALE, PURCH, BANK, CASH">
                    ...
                    <div class="md:col-span-6">
                        ...
                        <input wire:model.defer="name" type="text"
                            class="{{ $controlBase }} mt-2"
                            placeholder="Ej: Ventas, Compras, Banco...">
                        @error('name')
                            <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="md:col-span-8">
                        <div class="mt-6 rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900/30 p-4">
                            <p class="text-sm font-semibold text-gray-700 dark:text-gray-200 mb-2">
                                Tip: Códigos comunes estilo Odoo
                            </p>
                            <div class="flex flex-wrap gap-2 text-xs">
                                <span class="px-2 py-1 rounded bg-indigo-100 text-indigo-700 dark:bg-indigo-900/30 dark:text-indigo-300">SALE</span>
                                <span class="px-2 py-1 rounded bg-indigo-100 text-indigo-700 dark:bg-indigo-900/30 dark:text-indigo-300">PURCH</span>
                                <span class="px-2 py-1 rounded bg-indigo-100 text-indigo-700 dark:bg-indigo-900/30 dark:text-indigo-300">BANK</span>
                                <span class="px-2 py-1 rounded bg-indigo-100 text-indigo-700 dark:bg-indigo-900/30 dark:text-indigo-300">CASH</span>
                                <span class="px-2 py-1 rounded bg-indigo-100 text-indigo-700 dark:bg-indigo-900/30 dark:text-indigo-300">MISC</span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="pt-2 flex justify-end">
                    <button wire:click="update"
                        ...
                        <i class="fa-regular fa-floppy-disk"></i> Actualizar tipo de diario
                    </button>
                </div>
                @endcan
            @endif
