<div class="space-y-6">
    ...
    <div
        ...
        <div>
            <h1 class="text-2xl font-bold text-gray-800 dark:text-gray-100">Gestión de Categorías de los Posts</h1>
        ...
        <div class="flex flex-wrap gap-2">
            ...
            <a href="{{ route('admin.categoryposts.create') }}"
                ...
                <i class="fa-solid fa-plus mr-2"></i> Nueva Categoría del Post
            </a>
            ...
            <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                @forelse ($categoryposts as $categorypost)
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition">
                       ...
                       <!-- ID -->
                        <td class="px-4 py-3 text-center">{{ $categorypost->id }}</td>
                        ...
                        <td class="px-4 py-3 text-center">
                            <div class="flex justify-center gap-2">
                                <!-- Ver -->
                                <a href="{{ route('admin.categoryposts.show', $categorypost) }}"
                                ...
                                <!-- Editar -->
                                <a href="{{ route('admin.categoryposts.edit', $categorypost) }}" class="relative group inline-flex items-center justify-center w-8 h-8 rounded-full bg-gray-100 hover:bg-gray-200 dark:bg-gray-700 dark:hover:bg-gray-600 text-green-600 transition">
                                ...
                                <!-- Eliminar -->
                                {{-- <button onclick="confirmDeleteSingle({{ $categorypost->id }})" --}}
                                <button onclick="confirmDeletesimple({{ $categorypost->id }}, @js($categorypost->name), 'deleteRole', 'El Rol  {{ $categorypost->name }} con ID {{ $categorypost->id }} será eliminado.')"
    ...
    <!-- Paginación -->
    <div class="mt-4">{{ $categoryposts->links() }}</div>
