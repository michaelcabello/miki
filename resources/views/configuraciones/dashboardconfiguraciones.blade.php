    ...
    <div class="flex flex-col gap-6">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow px-6 py-3">
            <x-breadcrumb :links="[
                ...
                'Configuraciones' => route('dashboardconfiguraciones'),
            ]" />
        </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
                ...
                @php
                    $items = [
                        ...
                        ['title' => 'Usuarios', 'img' => 'usuarios.jpg', 'route' => route('dashboardcompras')],
                        ['title' => 'Permisos', 'img' => 'permisos.jpg', 'route' => route('dashboardventas')],
                        ['title' => 'Roles', 'img' => 'roles.jpg', 'route' => '#'],
